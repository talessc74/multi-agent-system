# Contexto do Projeto — EAI? Jurídico (Evidence-Based AI)
...
/
  ...
  .seeds/
    ...
    SCOUT.json · FLUX.json · LITERATE.json · RIVERRAID.json
    COMPASS.json · EMPIRICUS.json · POLARBEAR.json
    BLAST.json · BAU.json · SENTINEL.json · SOVEREIGN.json
