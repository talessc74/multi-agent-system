...
export default function ChatPanel({
  ...
  return (
    <>
            ...
            {([['lawyer', lawyerName], ['judge', judgeName]] as const).map(([type, label]) => (
              <button
                ...
                style={{
                  ...
                  borderRadius: '20px',
                  background: selectedAgent === type ? 'rgba(0,255,239,0.08)' : 'transparent',
      ...
      {/* Privacy Notice */}
      {showPrivacy && (
        <div style={{ position: 'fixed', inset: 0, zIndex: 320, background: 'rgba(0,0,0,0.75)', display: 'flex', alignItems: 'flex-end' }}>
